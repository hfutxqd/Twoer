...
import org.apache.commons.codec_android.language.bm.Languages.LanguageSet;
...
public class Rule {
    ...
    private static String createResourceName(final NameType nameType, final RuleType rt, final String lang) {
        return String.format("org/apache/commons/codec_android/language/bm/%s_%s_%s.txt",
    ...
    private static Scanner createScanner(final String lang) {
        final String resName = String.format("org/apache/commons/codec_android/language/bm/%s.txt", lang);
        final InputStream rulesIS = Languages.class.getClassLoader().getResourceAsStream(resName);
